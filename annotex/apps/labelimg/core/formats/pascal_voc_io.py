#!/usr/bin/env python
# -*- coding: utf8 -*-
"""Pascal VOC reader and writer - LabelImg's own, unchanged in what it emits."""
import codecs
...
class PascalVocReader:
    ...
    def parse_xml(self):
        if not self.file_path.endswith(XML_EXT):
            raise ValueError('Not a Pascal VOC annotation: %s' % self.file_path)
